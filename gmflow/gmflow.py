...
from .matching import global_correlation_softmax, local_correlation_softmax, global_transcorr_softmax
...
class GMFlow(nn.Module):
    def __init__(self,
        ...
        # Transformatcher
        ht, wd = image_size
        self.matcher = TransforMatcher('resnet50', [3,4], ht, wd)
    ...
    def forward(self, img0, img1,
        ...
        for scale_idx in range(self.num_scales):
            ...
            # feature0 = feature0_list[len(feature0_list)-1]
            feature0 = feature0_list[0]
            ...
            flow_pred = global_transcorr_softmax(feature0, corr_matrix)
